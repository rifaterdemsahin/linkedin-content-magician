              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-white/5 border border-white/20 rounded-lg">
                  <p className="text-sm text-gray-300 mb-3">
                    The following documents are available for indexing in your RAG.
                  </p>
                  <ul className="text-sm text-gray-300 space-y-1 list-disc list-inside">
                    <li>ai_tools.md</li>
                    <li>analytics_metrics.md</li>
                    <li>linkedin_strategy.md</li>
                    <li>personal_branding.md</li>
                    <li>video_production.md</li>
                  </ul>
                  <button
                    onClick={indexContent}
                    className="w-full bg-green-500 hover:bg-green-600 py-2 px-4 rounded-lg font-medium transition-all mt-4"
                  >
                    Re-index Content
                  </button>
                </div>
                {indexingOutput && (
                  <Alert variant={vectorDB.status === 'connected' ? 'success' : 'danger'}>
                    <pre>{indexingOutput}</pre>
                  </Alert>
                )}
